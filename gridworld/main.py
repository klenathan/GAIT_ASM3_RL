...
def main():
    ...
    parser.add_argument("--algo", type=str, default="q_learning", choices=["q_learning", "sarsa"])
    parser.add_argument("--episodes", type=int, default=500, help="Number of training episodes")
    parser.add_argument("--render_delay", type=float, default=0.01, help="Delay between steps in seconds")
    parser.add_argument("--no_render", action="store_true", help="Disable rendering for faster training")
    ...
    if args.algo == "q_learning":
        agent = QLearningAgent(actions, ALPHA, GAMMA, EPSILON_START, EPSILON_END, EPSILON_DECAY)
    else:
        agent = SARSAAgent(actions, ALPHA, GAMMA, EPSILON_START, EPSILON_END, EPSILON_DECAY)
